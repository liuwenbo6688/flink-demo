...
//        rocksDBStateBackend.enableTtlCompactionFilter();
        ...
        FlinkKafkaConsumerBase<String> kafkaConsumer = new FlinkKafkaConsumer010<String>(
                "user_event", new SimpleStringSchema(), props)
                .setStartFromGroupOffsets();

        env.addSource(kafkaConsumer)
                .map(log -> JSONObject.parseObject(log, UserVisitWebEvent.class))  // 反序列化 JSON
