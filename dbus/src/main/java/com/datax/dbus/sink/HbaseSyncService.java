...
import com.datax.dbus.utils.Md5Utils;
...
public class HbaseSyncService implements Serializable {
    ...
    private static final Logger log = LoggerFactory.getLogger(HbaseSyncService.class);
...
//    }
    ...
    private void insert(Flow flow, FlatMessage dml) {
        ...
        for (Map<String, String> r : data) {
            ...
            if (i % flow.getCommitBatch() == 0 && !rows.isEmpty()) {// 分批插入
